...
public class boardThreeO extends AppCompatActivity implements View.OnClickListener {
    ...
    private int nice = 0xFF890725;
    private int nicc = 0xFF000000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_board_three_o);
